...
function HomePage() {
  const [isGettingStartedModalOpen, setGettingStartedModalOpen] =
    useState(false);
  ...
  return (
    <div className="container">
      ...
      <h1 className="title">
        Welcome to Chef Companion, your personal recipe generator!
      </h1>
      <p className="description">
        Generate recipes based on what you have from your pantry and kitchen!
      </p>
      <Link to="/main">
        <button className="button">Main Page</button>
      </Link>
      <br />
      <button className="button" onClick={openGettingStartedModal}>
        Getting Started
      </button>
      <GettingStartedModal
